...
class GreedyLookAhead(DepthFirst):
    ...
    def build_children(self, grid, house):
        ...
        for valid_battery in valid_batteries:
            ...
            # print('H',house.id, new_grid.houses[house.id].distance)
    ...
    #     elif grid not in self.failed_paths:
    ...
    #             print('failed:', self.failed_paths)
    ...
    #                 print('afstand', new_house.id, new_house.distance)
